...
**645 unit tests plus 535 security-rules tests.** `pnpm verify` green.
...
**the full rules matrix** (P8.3), the paperwork as
[docs/GDPR.md](docs/GDPR.md) (P8.5), and **the Stanley–Brown safety plan** —
six sections on one page, replacing the single warning-signs list.

Still open: personalised crisis contacts, supporter guidance, the
error-handling sweep (P8.4) and the family pilot (P8.6), planned in
